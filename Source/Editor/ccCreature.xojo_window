...
#tag WindowCode
	#tag Method, Flags = &h0
		Function GetXMLNode() As XMLNode
		  ...
		  // Description
		  if cDescription.Value <> "" or ccSourceBox.GetSources.LastIndex > -1 then
		    SetDescription( xCreature, cDescription.Value, ccSourceBox.GetSources, "description" )
		  end if
		  ...
		  if TheNode <> Nil then
		    ...
		    for index as Integer = 0 to TheNode.ChildCount-1
		      ...
		      case "trait"
		        ...
		        case "Source"
		          ccSourceBox.SetSources( xChild.ValueOfNodeWithName("text") )
...
#tag Events cLanguagesKnown
	#tag Event
		Sub Open()
		  ...
		  me.BaseMenu.AddMenu new MenuItem("-")
		  me.BaseMenu.AddMenu new MenuItem("Any 1 language (usually Common)")
