#tag Class
Protected Class AddDuplicateRemoveEdit
Inherits SegmentedControl
	...
	#tag Event
		Sub Open()
		  'self.SegmentStyle = SegmentedControlExtension.NSSegmentStyle.SmallSquare
		    ...
		    'self.ImageForSegment(2).Template = True
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			...
			End Set
		#tag EndSetter
		DuplicateEnabled As Boolean
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  return self.EnabledForSegment(3)
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  self.EnabledForSegment(3) = Value
			End Set
		#tag EndSetter
