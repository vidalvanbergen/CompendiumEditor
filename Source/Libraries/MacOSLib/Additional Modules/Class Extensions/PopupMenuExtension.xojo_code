...
Protected Module PopupMenuExtension
	#tag Method, Flags = &h0
		Sub AddRowWithTagAndPicture(extends p as PopupMenu, Name as String, Tag as Variant, Ico as Picture = Nil)
		  ...
		  if TargetMacOS and Ico <> nil then
		    p.Icon( p.ListCount - 1, True ) = NSImage.CreateFromPicture( Ico )
		  end if
		End Sub
	#tag EndMethod
